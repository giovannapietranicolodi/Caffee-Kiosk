 ...
 */
public class DBMenu implements Catalog {

    private static final Logger LOGGER = LoggerFactory.getLogger(DBMenu.class);
     ...
     */
    public DBMenu(MenuRepository menuRepository) {
